      ...
      <div className="mx-auto w-full sm:px-6 lg:px-8 pb-20 rounded-lg">
        <div className="relative isolate overflow-hidden  px-6 shadow-2xl sm:rounded-3xl sm:px-16 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          <svg
            ...
            aria-hidden="true"
            className="absolute left-1/2 top-1/2  w-[64rem] -translate-y-1/2 [mask-image:radial-gradient(closest-side,white,transparent)] sm:left-full sm:-ml-80 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2 lg:translate-y-0"
          >
            <circle
              r={512}
              cx={412}
